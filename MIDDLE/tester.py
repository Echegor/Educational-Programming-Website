...
getQuestionDetail = r'https://web.njit.edu/~jjr27/submitTest.php'
	...
	[
		{
			...
			"answer":"int x(int i){\\nreturn 1;\\n}",
			"grade":100,
			"gradeExplanation":"Good job, for your input x(1), you got 1. The correct answer was 1 \\nGood job, for your input x(1), you got 1. The correct answer was 1 \\nGood job, for your input x(1), you got 1. The correct answer was 1 \\n"
		}
	]
}
...
post = s.post(getQuestionDetail, data=json.dumps(payload))
